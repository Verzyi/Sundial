# Description: This file contains the machine_info function which is used to fetch the machine data from the EOS machines. i have commented it out because delopying to aws and function not needed for display 
# import sqlite3
