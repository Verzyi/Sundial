...
appender = DatabaseAppender("InventoryVirginBatch_20230621.csv", "inventory_virgin_batch")
appender.append_to_database()
appender = DatabaseAppender("MaterialsTable_20230621.csv", "materials_table")
appender.append_to_database()
appender = DatabaseAppender("PowderBlendPart_20230406.csv", "Powder_Blend_Parts")
appender.append_to_database()
appender = DatabaseAppender("PowderBlend_20230621.csv", "powder_blends")
appender.append_to_database()
