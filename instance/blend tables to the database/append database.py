...
appender.append_to_database()
appender = DatabaseAppender("PowderBlendPart_20230626_1514.csv", "Powder_Blend_Parts")
appender.append_to_database()
appender = DatabaseAppender("PowderBlend_20230626_1515.csv", "powder_blends")
appender.append_to_database()
appender = DatabaseAppender("PowderBlendCalc_20230626_1533.csv", "Powder_Blend_Calc")
appender.append_to_database()
