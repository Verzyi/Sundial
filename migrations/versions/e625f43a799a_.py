...
Revision ID: e625f43a799a
Revises: 4e63a069b954
Create Date: 2023-11-29 09:27:57.517866
...
revision = 'e625f43a799a'
down_revision = '4e63a069b954'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    sa.ForeignKeyConstraint(['CreatedBy'], ['users.id'], name='fk_ncr_user'),
...
def downgrade():
    ...
    with op.batch_alter_table('builds_table', schema=None) as batch_op:
        batch_op.add_column(sa.Column('Location', sa.BIGINT(), nullable=True))
        batch_op.alter_column('BuildType',
               existing_type=sa.String(),
               type_=sa.TEXT(),
               existing_nullable=True)
