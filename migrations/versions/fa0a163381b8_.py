...
Revision ID: fa0a163381b8
Revises: 6cd07e56516d
Create Date: 2023-11-29 23:50:21.916891
...
revision = 'fa0a163381b8'
down_revision = '6cd07e56516d'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    with op.batch_alter_table('powder_blends', schema=None) as batch_op:
        ...
        batch_op.create_foreign_key('fk_blend_alloy', 'material_alloys', ['AlloyID'], ['AlloyID'])
...
def downgrade():
    ...
    with op.batch_alter_table('powder_blends', schema=None) as batch_op:
        batch_op.drop_constraint('fk_blend_alloy', type_='foreignkey')
        batch_op.drop_constraint(None, type_='unique')
        batch_op.alter_column('AlloyID',
               existing_type=sa.Integer(),
               type_=sa.BIGINT(),
