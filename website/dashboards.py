...
#     running_builds = AllBuilds.filter(BuildsTable.BuildFinishTime == None, BuildsTable.BuildStartTime != None)
#     running_builds = AllBuilds.order_by(desc(BuildsTable.StartTime)).first()
#     finished_builds = AllBuilds.filter(BuildsTable.BuildFinishTime != None, BuildsTable.BuildStartTime != None)
